...
const Header = () => {
  ...
  const login = async () => {  //while using await we have to use async fuunctiom
  ...
  return (
    <header className='fixed z-50 w-screen  p-3 px-4 md:p-6 md:px-16'>
        ...
        <div className='hideen md:flex w-full h-full items-center justify-between'>
          ...
          <div className='flex items-center gap-8'>
           <motion.ul initial={{opactity : 0, x : 200 }}
            animate={{opactity : 1, x : 0 }}
            exit={{opactity : 0, x : 200 }} className='flex items-center gap-8'>
        ...
        <div className='relative'>
         ...
         {
          isMenu && (
            <motion.div initial={{opactity : 0, scale : 0.6}}
            animate={{opactity : 1, scale : 1}}
            exit={{opactity : 0, scale : 0.6}} className="w-40 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute  top-12 right-0">
            {
...

         {
          ...
          <ul  className='flex flex-col'>
            ...
            <li className='text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2 '>Service</li>
             ...
             <p className="m-2 p-2 rounded-md shadow-lg flex items-center justify-center bg-gray-200 gap-3 cursor-pointer hover:bg-gray-300 transition-all duration-100 ease-in-out text-textColor text-base" onClick={logout}>Logout <MdLogout/></p>
            </motion.div> 
          )
         }
